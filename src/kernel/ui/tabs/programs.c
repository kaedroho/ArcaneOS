...
struct ui_tab_program_program[1];

void ui_tab_programs_init()
{
//Zero variables
    ui_tab_program_programcount=1;
    ui_tab_currentselectedprogram=0;

//Add crashtest
    ui_tab_program_program[0].name="Crashtest";
    ui_tab_program_program[0].namelength=sizeof("Crashtest");
    ui_tab_program_program[0].main=program_crashtest_main;
    ui_tab_program_program[0].kbhandler=program_crashtest_kbhandler;
}
...
//Set keyboard handler
    kb_setkeyboardhandler(ui_tab_program_program[programid].kbhandler);

//Call main function
    ui_tab_program_program[programid].main();
